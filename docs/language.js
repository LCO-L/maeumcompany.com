...
const MAEUM_LANG = {
    ...
    // Language-specific paths (will be adjusted based on current page depth)
    paths: {
        'en': {
            government: 'government-en/',
            enterprise: 'enterprise-en/',
            about: 'about/',
            monet: 'monet/'
        },
        'kr': {
            government: 'government-kr/',
            enterprise: 'enterprise-kr/',
            about: 'about/',
            monet: 'monet/'
        },
        // Japanese
        'jp': {
            government: 'government-jp/',
            enterprise: 'enterprise-jp/',
            about: 'about/',
            monet: 'monet/'
        },
        // Chinese Simplified
        'cn': {
            government: 'government-cn/',
            enterprise: 'enterprise-cn/',
            about: 'about/',
            monet: 'monet/'
        },
        // Vietnamese
        'vn': {
            government: 'government-vn/',
            enterprise: 'enterprise-vn/',
            about: 'about/',
            monet: 'monet/'
        },
        // Default fallback for languages not yet implemented
        'default': {
            government: 'government-en/',
            enterprise: 'enterprise-en/',
            about: 'about/',
    ...
    applyLanguage(lang) {
        const config = this.paths[lang] || this.paths['en'];
        ...
        const govLinks = document.querySelectorAll('.nav-government');
        const entLinks = document.querySelectorAll('.nav-enterprise');
        const aboutLinks = document.querySelectorAll('.nav-about');
        const monetLinks = document.querySelectorAll('.nav-monet');

        govLinks.forEach(link => {
            link.href = prefix + config.government;
        });

        entLinks.forEach(link => {
            link.href = prefix + config.enterprise;
        });

        aboutLinks.forEach(link => {
            link.href = prefix + config.about;
        });

        monetLinks.forEach(link => {
            link.href = prefix + config.monet;
        });
